...
TEST_CASE("add, no duplicate : template<array<char,3>, 5>") {
  set<array<char, 3>, 5> v;
  stringstream s1;
  v.add(array<char, 3>{'r', 's', 'i'});
  v.add(array<char, 3>{'!', '5', 'H'});
  v.add(array<char, 3>{'n', 'l', 'o'});
  v.add(array<char, 3>{'6', ',', '2'});
  s1 << v;
  REQUIRE(s1.str() == "[r,s,i],[!,5,H],[n,l,o],[6,,,2]");
}

TEST_CASE("add, duplicate : template<array<char,3>, 5>") {
  set<array<char, 3>, 5> v;
  stringstream s1;
  v.add(array<char, 3>{'r', 's', 'i'});
  v.add(array<char, 3>{'!', '5', 'H'});
...
TEST_CASE("remove, not in array : template<array<char,3>, 5>") {
  set<array<char, 3>, 5> v;
  stringstream s1;
  v.add(array<char, 3>{'r', 's', 'i'});
  v.add(array<char, 3>{'!', '5', 'H'});
  v.add(array<char, 3>{'n', 'l', 'o'});
  v.add(array<char, 3>{'6', ',', '2'});
  v.remove(array<char, 3>{'7', ',', '3'});
  s1 << v;
  REQUIRE(s1.str() == "[r,s,i],[!,5,H],[n,l,o],[6,,,2]");
}

TEST_CASE("remove, in array : template<array<char,3>, 5>") {
  set<array<char, 3>, 5> v;
  stringstream s1;
  v.add(array<char, 3>{'r', 's', 'i'});
  v.add(array<char, 3>{'!', '5', 'H'});
  v.add(array<char, 3>{'n', 'l', 'o'});
  v.add(array<char, 3>{'6', ',', '2'});
  v.remove(array<char, 3>{'6', ',', '2'});
  s1 << v;
  REQUIRE(s1.str() == "[r,s,i],[!,5,H],[n,l,o]");
}
